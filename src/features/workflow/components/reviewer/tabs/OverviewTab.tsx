        ...
        <div className="bg-white dark:bg-[#181B26] rounded-2xl border border-slate-200 dark:border-white/10 p-5 shadow-xs relative overflow-hidden flex flex-col justify-between space-y-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">
              Cần xử lý <code className="text-purple-600 dark:text-purple-400">content_brief</code> &amp; gán Token Quota
            </p>
          </div>
        </div>
            ...
            <div className="w-full bg-slate-100 dark:bg-white/10 h-1.5 rounded-full overflow-hidden mt-1.5 mb-1">
              <div
                className={`h-full rounded-full transition-all duration-500 ${
                  quotaPercent >= 90 ? 'bg-rose-500' : 'bg-purple-500'
                }`}
                  ...
                  >
                    ...
                    <td className="py-4 px-4 whitespace-nowrap">
                      {isPublished || isCompliancePassed ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold bg-slate-100 dark:bg-slate-500/10 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-500/20">
                    ...
                    <td className="py-4 px-4 text-right whitespace-nowrap">
                      {isPlanPending ? (
                        <button
                          ...
                          className="px-3.5 py-2 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs transition shadow-sm shadow-purple-600/20 active:scale-95 cursor-pointer inline-flex items-center gap-1.5"
                        >
                        ...
                        <Link
                          ...
                          className="px-3.5 py-2 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs transition shadow-sm shadow-purple-600/25 active:scale-95 cursor-pointer inline-flex items-center gap-1.5"
                        >
