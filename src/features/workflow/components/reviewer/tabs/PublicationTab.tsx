        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Ngày phát hành và nơi phát của từng tập
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 self-start sm:self-center">
            <span className="px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400 font-mono font-semibold text-xs">
              {publishedEpisodes.length}/{project.episodes.length} tập đã phát hành
            </span>
          </div>
        </div>
      </div>
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="space-y-1 min-w-0">
                    ...
                    <p className="text-[11px] text-slate-500 dark:text-slate-400 font-mono">
                      Thời lượng: {ep.total_duration} · Đã dùng: {ep.actual_tokens_used.toLocaleString()} token · Phụ trách: {project.creator_name}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 shrink-0 self-end md:self-center">
                  <div className="text-right hidden sm:block">
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 block">Dự kiến phát hành:</span>
