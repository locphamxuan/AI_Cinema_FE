        ...
        {currentStage && (
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-4 border-t border-slate-100 dark:border-white/5">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <select
                aria-label="Trạng thái giai đoạn"
                value={currentStage.status}
                onChange={(e) => updateMilestoneStatus(currentStage.milestoneId, e.target.value as MilestoneStatus)}
                className="px-2 py-2 text-xs rounded-lg bg-white dark:bg-[#12141A] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-white/10 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/50"
              >
