  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in pb-12">
      ...
      {historyMovies.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-slate-900/60 p-8 text-center text-sm text-slate-500 dark:text-slate-400">
          Chưa có lịch sử xem phim. Sau khi backend sẵn sàng, danh sách sẽ được tải từ API.
        </div>
      ) : (
